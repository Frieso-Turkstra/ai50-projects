...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        for i in range(cell[0] - 1, cell[0] + 2):
            for j in range(cell[1] - 1, cell[1] + 2):
                ...
                # check if cell is in bound, safe or a mine
                if 0 <= i < self.height and 0 <= j < self.width:
        ...
        while True:
            ...
            for sentence in self.knowledge.copy():
                # mark cells that are inferrably safe
                for safe in sentence.known_safes():
                    self.mark_safe(safe)
                    changed = True
                # mark cells that are inferrably mines
    ...
    def make_random_move(self):
        ...
        possible_moves = all_moves.difference(self.moves_made, self.mines)

        return random.choice(tuple(possible_moves)) if possible_moves else None
